...
typedef enum {QPS_SMALXE_INNER_TOL_STD,QPS_SMALXE_INNER_TOL_RHS,QPS_SMALXE_INNER_TOL_RHSINNER,QPS_SMALXE_INNER_TOL_STDMAX,QPS_SMALXE_INNER_TOL_RHSMAX,QPS_SMALXE_INNER_TOL_RHSINNERMAX,QPS_SMALXE_INNER_TOL_OUTER} QPSSMALXEInnerTolType;
