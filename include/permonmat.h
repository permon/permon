...
typedef enum {
  MAT_TRANSPOSE_EXPLICIT,
  MAT_TRANSPOSE_IMPLICIT,
  MAT_TRANSPOSE_CHEAPEST
} MatTransposeType;
...
typedef enum {
  MAT_ORTH_FORM_IMPLICIT = 0,
  MAT_ORTH_FORM_EXPLICIT = 1
} MatOrthForm;
